...
int main() {
    ...
    vdma_setup(&handle_s2mm, VDMA_S2MM, WIDTH, HEIGHT, 2, 0x10000000, 0x11000000, 0x12000000);
    vdma_setup(&handle_mm2s, VDMA_MM2S, WIDTH, HEIGHT, 2, 0x10000000, 0x11000000, 0x12000000);
