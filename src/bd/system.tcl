...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net fifo_mm2s_M_AXIS [get_bd_intf_pins stream_to_vga_0/rgb_in] [get_bd_intf_pins fifo_mm2s/M_AXIS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins stream_to_vga_0/clk25] [get_bd_pins fifo_mm2s/m_aclk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins rst_vga_clk25/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ov7670_pclk1_peripheral_aresetn [get_bd_pins stream_to_vga_0/aresetn] [get_bd_pins rst_vga_clk25/peripheral_aresetn]
