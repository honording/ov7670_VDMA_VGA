...
CONFIG.CONST_VAL {0} \
  ...
  set vdma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma:6.2 vdma ]
  set_property -dict [ list \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_S2MM [get_bd_intf_pins vdma/M_AXI_S2MM] [get_bd_intf_pins vdma_s2mm_intercon/S00_AXI]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins fifo_s2mm/M_AXIS] [get_bd_intf_pins vdma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net fifo_mm2s_M_AXIS [get_bd_intf_pins fifo_mm2s/M_AXIS] [get_bd_intf_pins stream_to_vga_0/rgb_in]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins axi_periph/M00_AXI] [get_bd_intf_pins vdma/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net vdma_s2mm_M_AXIS_MM2S [get_bd_intf_pins fifo_mm2s/S_AXIS] [get_bd_intf_pins vdma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net vdma_s2mm_M_AXI_MM2S [get_bd_intf_pins vdma/M_AXI_MM2S] [get_bd_intf_pins vdma_mm2s_intercon/S00_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_periph/ACLK] [get_bd_pins axi_periph/M00_ACLK] [get_bd_pins axi_periph/M02_ACLK] [get_bd_pins axi_periph/S00_ACLK] [get_bd_pins fifo_mm2s/s_aclk] [get_bd_pins fifo_s2mm/m_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins vdma/m_axi_mm2s_aclk] [get_bd_pins vdma/m_axi_s2mm_aclk] [get_bd_pins vdma/m_axis_mm2s_aclk] [get_bd_pins vdma/s_axi_lite_aclk] [get_bd_pins vdma/s_axis_s2mm_aclk] [get_bd_pins vdma_mm2s_intercon/ACLK] [get_bd_pins vdma_mm2s_intercon/M00_ACLK] [get_bd_pins vdma_mm2s_intercon/S00_ACLK] [get_bd_pins vdma_s2mm_intercon/ACLK] [get_bd_pins vdma_s2mm_intercon/M00_ACLK] [get_bd_pins vdma_s2mm_intercon/S00_ACLK]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_periph/M00_ARESETN] [get_bd_pins axi_periph/M02_ARESETN] [get_bd_pins axi_periph/S00_ARESETN] [get_bd_pins fifo_mm2s/s_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins vdma/axi_resetn] [get_bd_pins vdma_mm2s_intercon/M00_ARESETN] [get_bd_pins vdma_mm2s_intercon/S00_ARESETN] [get_bd_pins vdma_s2mm_intercon/M00_ARESETN] [get_bd_pins vdma_s2mm_intercon/S00_ARESETN]
  connect_bd_net -net stream_to_vga_0_blue [get_bd_ports vga_b] [get_bd_pins stream_to_vga_0/blue]
  connect_bd_net -net stream_to_vga_0_fsync [get_bd_pins stream_to_vga_0/fsync] [get_bd_pins vdma/mm2s_fsync]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vdma/S_AXI_LITE/Reg] SEG_vdma_s2mm_Reg
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces vdma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces vdma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
