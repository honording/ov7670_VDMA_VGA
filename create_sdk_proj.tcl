...
proc ov7670_create_arm_app {proj_name {hw_mame system_wrapper_hw_platform_0}} {
    set cur_dir $::current_dir
    ...
    sdk import_sources -name sysconfig -path "$cur_dir/src/sdk"
...
if {[ov7670_create_arm_app $project_name] == 0} {
